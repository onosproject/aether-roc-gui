                    ...
                    ScopeOfDataSource.data
                        ...
                        .forEach((listItem, listItemCount) => {
                            ...
                            if (basketItems.imsis) {
                                if (
                                    ScopeOfDataSource.data[listItemCount].imsis
                                        .length === 0
                                ) {
                                    ScopeOfDataSource.data[
                                        listItemCount
                            ...
                            if (basketItems.device && basketItems.device.mbr) {
                                ScopeOfDataSource.data[
                                    ...
                                    basketItems.device.mbr.uplink;
                                ScopeOfDataSource.data[
                                    listItemCount
                                ].device.mbr.downlink =
                                    basketItems.device.mbr.downlink;
                                ScopeOfDataSource.data[listItemCount].device[
                                    'traffic-class'
                                ] = basketItems.device['traffic-class'];
                            }
                            if (basketItems['ip-domain']) {
                                ScopeOfDataSource.data[listItemCount][
                                    'ip-domain'
                                ] = basketItems['ip-domain'];
                            }
                        });
                }
            );
