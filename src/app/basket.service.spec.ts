...
describe('BasketService', () => {
    ...
    it('should iterate through form', () => {
        ...
        // ('/basket-update/enterprise-2.0.0/enterprise-profile[id1]/0/connectivity-services[cs1]/0/enabled'))
        // .toBe('true');
    ...
    it('should produce a patchbody', () => {
        ...
        // ('/basket-delete/enterprise-2.0.0/enterprise-profile[id3]/connectivity-service[sint]/connectivity-service','sint');
