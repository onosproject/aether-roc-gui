...
import { SiteImsiDefinition, Site } from '../openapi3/aether/2.1.0/models';
...
export abstract class RocMonitorBase {
    ...
    public fullImsi(site: Site, imsiId: number): string {
        const imsiDef = site['imsi-definition'] as SiteImsiDefinition;
