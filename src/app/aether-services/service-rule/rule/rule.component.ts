                ...
                ScopeOfDataSource.data.forEach((listItem, listItemCount) => {
                    if (basketItems.id === listItem.id) {
                        ...
                        if (basketItems.qos && basketItems.qos['guaranteed-bitrate'] && basketItems.qos['guaranteed-bitrate'].downlink) {
                            ScopeOfDataSource.data[listItemCount].qos['guaranteed-bitrate'].downlink
                            = basketItems.qos['guaranteed-bitrate'].downlink;
                        }
                        if (basketItems.qos && basketItems.qos[ 'guaranteed-bitrate'] && basketItems.qos[ 'guaranteed-bitrate'].uplink) {
                            ScopeOfDataSource.data[listItemCount].qos['guaranteed-bitrate'].uplink
                            = basketItems.qos['guaranteed-bitrate'].uplink;
                        }
                        if (basketItems.qos && basketItems.qos['aggregate-maximum-bitrate']
                        && basketItems.qos['aggregate-maximum-bitrate'].downlink){
                            ScopeOfDataSource.data[listItemCount].qos['aggregate-maximum-bitrate'].downlink
                            = basketItems.qos['aggregate-maximum-bitrate'].downlink;
                        }
                        if (basketItems.qos && basketItems.qos['aggregate-maximum-bitrate']
                        && basketItems.qos['aggregate-maximum-bitrate'].uplink) {
                            ScopeOfDataSource.data[listItemCount].qos['aggregate-maximum-bitrate'].uplink
                            = basketItems.qos['aggregate-maximum-bitrate'].uplink;
                        }
                        if (basketItems.qos && basketItems.qos['maximum-requested-bandwidth']
                        && basketItems.qos['maximum-requested-bandwidth'].downlink) {
                            ScopeOfDataSource.data[listItemCount].qos['maximum-requested-bandwidth'].downlink
                            = basketItems.qos['maximum-requested-bandwidth'].downlink;
                        }
                        if (basketItems.qos && basketItems.qos['maximum-requested-bandwidth'] && basketItems.qos['maximum-requested-bandwidth'].uplink) {
                            ScopeOfDataSource.data[listItemCount].qos['maximum-requested-bandwidth'].uplink
                            = basketItems.qos['maximum-requested-bandwidth'].uplink;
                        }
