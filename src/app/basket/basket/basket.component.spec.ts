...
describe('The BasketComponent', () => {
    ...
    it('should display stuff from localstorage', () => {
        ...
        localStorage.setItem(
            '/basket-update/Security-profile-4.0.0/Security-profile[]/0/key',
            '{"newValue":"key2","oldValue":"key1"}'
        );
        localStorage.setItem(
            '/basket-update/Security-profile-4.0.0/Security-profile[]/0/opc',
            '{"newValue":"opcValue2","oldValue":"opcValue1"}'
        );
        localStorage.setItem(
            '/basket-update/Security-profile-4.0.0/Security-profile[]/0/id',
            '{"newValue":"ap2","oldValue":"ap1"}'
        );
        localStorage.setItem(
            '/basket-update/Security-profile-4.0.0/Security-profile[]/1/key',
            '{"newValue":"key2","oldValue":"key1"}'
        );
        localStorage.setItem(
            '/basket-update/Security-profile-4.0.0/Security-profile[]/1/num',
            '{"newValue":5678,"oldValue":1234}'
        );
        localStorage.setItem(
            '/basket-update/Security-profile-4.0.0/Security-profile[]/0/boolean',
            '{"newValue":true,"oldValue":false}'
        );
        localStorage.setItem(
            '/basket-delete/Security-profile-4.0.0/Security-profile[]/0/desc',
            '{"newValue":"undefined","oldValue":"desc1"}'
        );
        localStorage.setItem(
            '/basket-delete/Security-profile-4.0.0/Security-profile[]/0/something',
            '{"newValue":"undefined","oldValue":"something1"}'
        );
        localStorage.setItem(
            '/basket-delete/Security-profile-4.0.0/Security-profile[]/1/desc',
            '{"newValue":"undefined","oldValue":"desc2"}'
        );
    });
