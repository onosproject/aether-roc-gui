...
import { UpfUpfService } from '../../../openapi3/aether/2.0.0/services';
import {
...
export class UpfEditComponent extends RocEditBase implements OnInit {
    ...
    constructor(
        ...
        super(snackBar, bs, route, router, 'Upf-2.0.0', 'upf');
    ...
    //         // this.upfForm.get('enterprise').setValue(this.enterprises[0]['upfid);
    //     }
    // }
            ...
            .subscribe(
                ...
                () => {
                    ...
                    if (
                        ...
                        basketPreview['Upf-2.0.0'].upf.forEach(
                            (basketItems) => {
