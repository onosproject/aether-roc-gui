...
export class AetherV100TargetAccessProfileAccessProfileidService extends BaseService {
  constructor(
  ...
  getAetherV100TargetAccessProfileAccessProfile$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, AetherV100TargetAccessProfileAccessProfileidService.GetAetherV100TargetAccessProfileAccessProfilePath, 'get');
    if (params) {
