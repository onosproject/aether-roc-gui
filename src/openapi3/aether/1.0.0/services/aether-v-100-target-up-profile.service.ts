...
export class AetherV100TargetUpProfileService extends BaseService {
  constructor(
  ...
  getAetherV100TargetUpProfileUpProfile$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, AetherV100TargetUpProfileService.GetAetherV100TargetUpProfileUpProfilePath, 'get');
    if (params) {
