...
export class SiteSiteMonitoringEdgeDeviceService extends BaseService {
  ...
  getSiteSiteMonitoringEdgeDevice$Response(params: {
     ...
     */
    'edge-device-id': any;
  }): Observable<StrictHttpResponse<EnterpriseEnterpriseSiteMonitoringEdgeDevice>> {
    ...
    return this.http.request(rb.build({
      ...
      map((r: HttpResponse<any>) => {
        return r as StrictHttpResponse<EnterpriseEnterpriseSiteMonitoringEdgeDevice>;
      })
    );
  }
  ...
  getSiteSiteMonitoringEdgeDevice(params: {
     ...
     */
    'edge-device-id': any;
  }): Observable<EnterpriseEnterpriseSiteMonitoringEdgeDevice> {

    return this.getSiteSiteMonitoringEdgeDevice$Response(params).pipe(
      map((r: StrictHttpResponse<EnterpriseEnterpriseSiteMonitoringEdgeDevice>) => r.body as EnterpriseEnterpriseSiteMonitoringEdgeDevice)
    );
  }
