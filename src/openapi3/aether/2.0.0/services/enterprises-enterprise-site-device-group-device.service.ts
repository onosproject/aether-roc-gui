...
export class EnterprisesEnterpriseSiteDeviceGroupDeviceService extends BaseService {
   ...
   */
  static readonly GetEnterprisesEnterpriseSiteDeviceGroupDeviceListPath = '/aether/v2.0.0/{target}/enterprises/enterprise/{enterprise-id}/site/{site-id}/device-group/{device-group-id}/device';
