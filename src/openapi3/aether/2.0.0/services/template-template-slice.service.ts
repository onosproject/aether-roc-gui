...
import {EnterpriseEnterpriseTemplateSlice} from "../models/enterprise-enterprise-template-slice";
...
export class TemplateTemplateSliceService extends BaseService {
  ...
  getTemplateTemplateSliceMbr$Response(params: {
     ...
     */
    id: any;
  }): Observable<StrictHttpResponse<EnterpriseEnterpriseTemplateSliceMbr>> {
    ...
    return this.http.request(rb.build({
      ...
      map((r: HttpResponse<any>) => {
        return r as StrictHttpResponse<EnterpriseEnterpriseTemplateSliceMbr>;
      })
    );
  }
  ...
  getTemplateTemplateSliceMbr(params: {
     ...
     */
    id: any;
  }): Observable<EnterpriseEnterpriseTemplateSliceMbr> {

    return this.getTemplateTemplateSliceMbr$Response(params).pipe(
      map((r: StrictHttpResponse<EnterpriseEnterpriseTemplateSliceMbr>) => r.body as EnterpriseEnterpriseTemplateSliceMbr)
    );
  }
