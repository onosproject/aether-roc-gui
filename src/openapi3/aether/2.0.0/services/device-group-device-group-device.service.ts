...
export class DeviceGroupDeviceGroupDeviceService extends BaseService {
  ...
  getDeviceGroupDeviceGroupDeviceMbr$Response(params: {
     ...
     */
    id: any;
  }): Observable<StrictHttpResponse<EnterpriseEnterpriseSiteDeviceGroupMbr>> {
    ...
    return this.http.request(rb.build({
      ...
      map((r: HttpResponse<any>) => {
        return r as StrictHttpResponse<EnterpriseEnterpriseSiteDeviceGroupMbr>;
      })
    );
  }
  ...
  getDeviceGroupDeviceGroupDeviceMbr(params: {
     ...
     */
    id: any;
  }): Observable<EnterpriseEnterpriseSiteDeviceGroupMbr> {

    return this.getDeviceGroupDeviceGroupDeviceMbr$Response(params).pipe(
      map((r: StrictHttpResponse<EnterpriseEnterpriseSiteDeviceGroupMbr>) => r.body as EnterpriseEnterpriseSiteDeviceGroupMbr)
    );
  }
